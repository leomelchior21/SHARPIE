...
export const variableRunLessons: VariableRunLesson[] = [
  ...
  },
  {
    ...
    correct: 1,
    blocks: ["2024", ";", "city", "int", '"Paris"', "=", "year", "string", ";", "="],
    expectedBlocks: ["string", "city", "=", '"Paris"', ";", "int", "year", "=", "2024", ";"],
    feedback: "You built both memories and predicted their output.",
    hint: "Build type, name, equals, value, semicolon—twice. One for text, one for a whole number.",
    finalCode: 'string city = "Paris";\nint year = 2024;',
  },
];
